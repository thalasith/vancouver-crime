          ...
          function n() {
            ...
            function d(r, t) {
              function e(e, n, u) {
                ...
                if (tt)
                  ...
                  for (var b = 0; v > b; ++b)
                    (z[G][V[b] + n] |= W), t && (rt[b] = 1);
                  for (var _ = d; u > _; ++_)
                    (z[G][V[_] + n] |= W), t && (rt[_] = 1);
                }
                if (!n)
                  return (
                    (H = Q),
              ...
              function _(r) {
                ...
                var o,
                  ...
                  s = [];
                if (lt > e)
                  for (o = e, i = Math.min(lt, n); i > o; ++o)
                    f.push(K[o]), c.push(o);
                else if (e > lt)
                  for (o = lt, i = Math.min(e, ht); i > o; ++o)
                    a.push(K[o]), s.push(o);
                if (n > ht)
                  for (o = Math.max(e, ht), i = n; i > o; ++o)
                    f.push(K[o]), c.push(o);
                else if (ht > n)
                  for (o = Math.max(lt, n), i = ht; i > o; ++o)
                    a.push(K[o]), s.push(o);
                if (t) {
                  var l = [],
                    h = [];
              ...
              function D(r, e) {
                ...
                for (n = lt; ht > n && r > 0; )
                  z.zero((o = K[n])) && (u > 0 ? --u : (i.push(S[o]), --r)),
                    n++;
                return i;
              }
              function I(r) {
                ...
                function n(r) {
                  if (B > 1 || t) {
                    ...
                    if (t) {
                      for (e = 0, u = 0; M > e; ++e)
                        if (r[e] !== m) {
                          for (q[u] = q[e], n = 0; n < q[u].length; n++)
                            l[q[u][n]] = 1;
                          ++u;
                        }
                    } else
                ...
                function a(r, t, e, n, o) {
                  if (!((r === W && t === G) || X)) {
                    ...
                    for (i = 0, f = e.length; f > i; ++i)
                      z.zeroExcept((u = e[i]), G, J) &&
                        (a.value = U(a.value, S[u], !1));
                ...
                function d() {
                  var r,
                    t = C[0];
                  for (t.value = I(), r = 0; M > r; ++r)
                    t.value = U(t.value, S[r], !0);
                  for (r = 0; M > r; ++r)
            ...
            function k(r) {
              return "function" != typeof r
                ? (console.warn(
                    "onChange callback parameter must be a function!"
                  ),
                  void 0)
                : (q.push(r),
                  function() {
            ...
            var z,
              ...
              q = [];
            return (
              (z = new f.bitarray(0)), arguments.length ? r(arguments[0]) : j
            );
          }
          function o(r, t) {
